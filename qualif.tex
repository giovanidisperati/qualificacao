...
Com os dados colhidos e os experimentos realizados, será possível avaliar os sinais aquisitados, verificando-se a corretude do sistema de aquisição, os ajustes de posicionamento dos sensores e, por fim, introdução de falhas nos rolamentos afim de que se diferencie os sinais de um rolamento em bom estado dos sinais de um defeituoso. 
