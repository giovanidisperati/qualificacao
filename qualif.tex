...
Dentre as distintas aplicações do PVDF, Xin et al., 2016, fizeram uma revisão de literatura quanto ao seu uso enquanto sensor de vibrações. Nesta, apresentam, dentre outras, aplicações para dispositivos médicos portáteis, monitoramento de saúde estrutural, monitoramento de maquinário, dentre outras aplicações diversas.
...
Em relação ao PVDF como sensor aplicado a monitoramento de saúde estrutural, citam:

Já O PVDF como sensor aplicado a medição de vibrações em maquinário, as principais aplicações citadas são:
...
Por fim, citam algumas aplicações do PDVF como sensor aplicado em outras áreas:
