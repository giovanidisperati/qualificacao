...
%\newcommand{\listadeequacoesnome}{\center{\textbf{Lista de Equações}} \\}
%\newlistof{equations}{equ}{\listadeequacoesnome}
%\newcommand{\listadeequacoes}[1]{%
%\addcontentsline{equ}{listadeequacoes}{\protect\numberline{\theequation}#1}\par}
...
Assim, portanto, segundo Slack, 2008, p.645 “a manutenção preditiva visa realizar manutenção somente quando as instalações precisarem dela”. 
...
Além destes argumentos Holanda, 2016, chama a atenção para o fato de a manutenção preditiva ter como benefício colateral a capacidade de determinação automática do Tempo Médio Entre Falhas, MTBF (\textit{Mean Time Between Failures}). Segundo Holanda, 2016, o MTBF 
...
%\end{equation}
%\listadeequacoes{Equation number \ref{eq:Eq1}}

\[x = A \,sen (\omega t + \upphi)\]

A velocidade, por sua vez, é medida em milímetros por segundo ($mm/s$). A velocidade é a derivada primeira do deslocamento. O deslocamento implica na existência de uma velocidade que, por sua vez, pode ser variável. A função de velocidade, v, é dada por:
