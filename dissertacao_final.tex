...
O conhecimento prévio destas frequências é de grande importância na etapa de análise, uma vez que elas nos apontam as regiões do espectro onde as falhas devem se mostrar presentes.
...
Li et. al, 2011, explicitam o tratamento eletrônico para trabalho com o sensor PVDF, mostrando a importância de um filtro rejeita-faixa e de amplificação operacional. Também os autores apontam que dada à alta impedância, esse se torna facilmente sujeito aos ruídos ambientes - tal como verificado experimentalmente nos testes realizados neste trabalho.
...
A Figura~\ref{amplificador_filme_pvdf} mostra o desenho esquemático do circuito de condicionamento do sinal do sensor piezoelétrico. Nele buscou-se a amplificação do sinal, tendo se optado pelo amplificador operacional de propósito geral Texas Instruments TL082, uma vez que este possui dois canais e larga banda de \SI{1}{\mega\hertz} (TEXAS INSTRUMENTS, 2021).
...
Os capacitores foram ligados em série para atingir os valores adequados e medidos com diferença inferior a 0.5\% entre si, de modo a fornecer melhor resultado no processo de filtragem. A Figura~\ref{circuito_notch} apresenta o desenho esquemático do circuito rejeita-faixa.
...
\begin{figure}[H]
\centering
\caption {Dano introduzido no elemento rolante. A seta vermelha aponta o elemento rolante onde o dano foi inserido.}
