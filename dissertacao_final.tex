...
A Figura~\ref{PSD_ROLAMENTO_BOM} apresenta o PSD do 
...
Para que o processamento deste envelope fosse realizado, a banda de seleção do filtro passa-faixa foi realizada manualmente com base na observação dos valores de curtose, conforme verificado na Figura~\ref{CURTOSE_ROLAMENTO_RUIM}.


\begin{figure}[H]
\centering
\caption {Espectro de densidade de potência do rolamento com dano no elemento rolante. Elaborado pelo autor.}
\includegraphics[width=\textwidth,height=100mm,keepaspectratio]{GraficosAnalise/curtose_rolamento_ruim}
Fonte: O autor (2022)
\label{CURTOSE_ROLAMENTO_RUIM}
\end{figure} 

Ainda, observa-se que neste valor de curtose há uma queda após os {\SI{2500}{\hertz} e CONTINUAR_AQUI
