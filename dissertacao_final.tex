...
Os danos nos rolamentos foram inseridos manualmente. A Figura

\begin{figure}[H]
\centering
\caption {Dano introduzido no elemento rolante.}
\includegraphics[width=\textwidth,height=60mm,keepaspectratio]{dano_introduzido_rolante}
\label{dano_introduzido_rolante}
\end{figure}

A análise dos resultados obtidos, por sua vez, se dá à luz da revisão bibliográfica. 
